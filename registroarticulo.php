				...
				<div class="wrapper">
					...
					<div id="page-content">
						...
						<h4 class="line-divider">Registro</h4>
                                                <form method='post' action="articuloguardado.php" id="formUser" class="form-horizontal">
						<div class="control-group">
							<label class="control-label" for="nombre">Nombre de articulo:</label>
							<div class="controls">
								<input id="nombre" name="nombre" type="text" placeholder="Nombre de articulo">
							</div>
						</div>
                        <div class="control-group">
							...
							<div class="controls">
								<input id="descripcion" name="descripcion" type="text" placeholder="Descripci&oacute;n">
                                                    ...
                                                    <div class="control-group">
							<label class="control-label" for="cantidad">Categoria:</label>
							<div class="controls">
                                                            <select name="categoria" id="categoria">
                                                                <?PHP
                                                                require 'lib/Inter.php';
                                                                $X = new Inter();
                                                                $resultado = $X->listaCategoria();
                        ...
                        <div class="control-group">
							...
							<div class="controls">
                                                            <select name="proveedor" id="proveedor">
                                                                ...
                                                                $resultado2 = $X->listaProveedor();
                                                                foreach($resultado2 as $res) {
                                                                
                                                                
                                                                ?>
                                                                <option value="<?php echo $res['id_proveedor'];?>"><?php echo  $res['nombre_proveedor'];}?></option>
                                                            </select>
							</div>
						</div>
						<div class="control-group">
