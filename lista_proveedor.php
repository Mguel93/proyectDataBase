	...
	<body>
        ...
        <?PHP
                                               ...
                                               $i=0; 
                                                ...
                                                $resultado = $X->listaProveedor();

                                               

                                                echo "<table border=\"1\">";
                                                echo "<td><b>id</b></td>"."<td><b>Nombre</b></td>"."<td><b>Direccion</b></td>"
                                                    ."<td><b>Telefono</b></td>"."<td><b>Ciudad</b></td>"
                                                    ."<td><b>Estado</b></td>"."<td><b>Rfc</b></td>";
