...
<!--									<li><a href="features-toggle.php"><span> Toggle box</span></a></li>
							...
							<li><a href="articulo.php">Articulos <span class="subheader">Articulos</span></a></li>
				...
				<div class="wrapper">
					...
					<div id="page-content">
						...
						<h4 class="line-divider">Registro</h4>
						      <form method='post' action="clienteguardado.php" id="formUser" class="form-horizontal">
