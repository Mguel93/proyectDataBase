			...
			<div id="main">
				...
				<div class="wrapper">
					...
					<div id="page-content">
						...
						<div class="one-half">
						<h4 class="line-divider"></h4>
						      <img class="imgdepto" src="images2/proveedores.png"/>
						</div>
					...
					<ul id="footer-cols">
						<li class="col">
							...
							<ul>
                                ...
                                <li class="page_item"><a href="empleado.html">Empleado</a></li>
                                <li class="page_item"><a href="proveedor.html">Proveedor</a></li>
							</ul>
						</li>
