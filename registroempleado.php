				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><a href="unidad.php">Unidades<span class="subheader">Awesome options</span></a>
								<ul>
...
<!--									<li><a href="features-toggle.php"><span> Toggle box</span></a></li>
									...
									<li><a href="features-monobox.php"><span> Icons</span></a></li>-->
                                                        ...
                                                        <li><a href="ventas.php">Ventas<span class="subheader">Read our posts</span></a></li>
							<li><a href="articulo.php">Articulos <span class="subheader">Showcase work</span></a></li>
                                                        <li><a href="cliente.php">Cliente<span class="subheader">Featured work</span></a>
								<ul>
							...
							<li><a href="almacen.php">Almacen<span class="subheader">Get in touch</span></a></li>
                                                        <li><a href="empleado.php">Empleado<span class="subheader">Get in touch</span></a>
                                                            <ul>
                                                                <li><a href="registroempleado.php"><span> Registro de empleado</span></a></li>
                                                            </ul>
                                                        </li>
                                                        <li><a href="proveedor.php">Proveedor<span class="subheader">Get in touch</span></a>
                                                            <ul>
				...
				<div class="wrapper">
					...
					<div id="page-content">
						...
						<h4 class="line-divider">Registro</h4>
						      <form method='post' action="registroempleado.php" id="formUser" class="form-horizontal">
						...
						<div class="control-group">
							<label class="control-label" for="last-name">Apellido Paterno</label>
							<div class="controls">
								<input id="last-name" name="last-name" type="text" placeholder="Apellido Paterno">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label" for="last-name2">Apellido Materno</label>
							<div class="controls">
								<input id="last-name2" name="last-name2" type="text" placeholder="Apellido Materno">
							</div>
						</div>
                        <div class="control-group">
							...
							<div class="controls">
                                ...
                                Femenino <INPUT TYPE="RADIO" NAME="sexo" VALUE="femmenino">
                                <P>
							</div>
						</div>
                        <div class="control-group">
							...
							<div class="controls">
								<input id="fecha" name="fecha" type="tel" placeholder="Fecha de Nacimiento" pattern="[0-9,-]{8}">
							</div>
						</div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
							<label class="control-label" for="correo">Puesto</label>
							<div class="controls">
	   ...
	   <?PHP
        ...
        $X->AgregarEmpleado($nombre, $apellidoP, $apellidoM, $sexo, $fecha, $direccion, $telefono, $email, $puesto);
