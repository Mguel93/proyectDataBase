					...
					<div id="content">
						...
						<div id="page-content">
                                               ...
                                               $i=0; 
                                                ...
                                                $resultado = $X->listaCliente();

                                               

                                                echo "<table border=\"1\">";
                                                echo "<td><b>id</b></td>"."<td><b>Nombre</b></td>"."<td><b>Apellido paterno</b></td>"
                                                    ."<td><b>Apellido materno</b></td>"."<td><b>Direccion</b></td>"
                                                    ."<td><b>Telefono</b></td>"."<td><b>Email</b></td>"."<td><b>Rfc</b></td>";
